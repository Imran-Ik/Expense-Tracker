...
const REQUIRED_BACKEND_VERSION = 7;
...
function renderBudget(budget) {
  ...
  html += budget.categories
    ...
    .map(function (c) {
      ...
      const remaining = (typeof c.actual === 'number') ? c.budget - c.actual : c.budget;
      ...
      return '' +
        '<div class="budget-row">' +
          '<div class="labels">' +
            ...
            '<span class="amounts">' + formatMoney(c.actual) + ' / ' + formatMoney(c.budget) +
